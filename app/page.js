...
export default function Home() {
  return (
    <div className="flex flex-col pt-16">
      <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <h1 className="gradient-title mx-auto max-w-4xl text-4xl font-bold md:text-7xl">
            The easiest way to share expenses with friends
          </h1>
          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed">
            Track shared expenses, split bills effortlessly, and settle up easily.
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            className="bg-blue-500 hover:bg-blue-600">
              <Link href='/dashboard'>
              Get Started
              <ArrowRight className="m1-2 h-4 w-4" />
              </Link>
            </Button>
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-8 lg:grid-cols-3">
            {STEPS.map(({description, label, title}) => (
              <div key={title} className="flex flex-col items-center space-y-4">
                ...
                bg-blue-100 text-xl font-bold text-blue-500">
                  {label}
                </div>
                <h3 className="text-xl font-bold">{title}</h3>
      ...
      <section className="py-20 gradient">
          <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
            ...
            <p className="mx-auto max-w-[600px] text-blue-100 md:text-xl/relaxed">
              Join thousands of users who have made sharing expenses stress-free
            </p>

            <Button asChild size="lg" className="bg-blue-700 hover:opacity-90">
              <Link href='/dashboard'>
              Get Started
              <ArrowRight className="m1-2 h-4 w-4" />
              </Link>
      ...
      <div className="border-t bg-gray-50 py-12 text-center text-muted-foreground">
      <footer className=" text-center text-sm">
        Made with 💖 by Akansh Aggarwal
      </footer>
      <footer className="text-xs">
        © {new Date().getFullYear()} ShareEz. All rights reserved.
      </footer>
      </div>      
    </div>
  );
